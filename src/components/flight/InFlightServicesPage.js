...
class InFlightServicesPage extends React.Component {
  state = {
    passengerIndex: null
  };
    ...
    return (
      <div>
        <nav>
          ...
          {" | "}
          <NavLink
            to={this.props.match.url + "/shoppings_items"}
            activeStyle={activeStyle}
          >
            Shopping Items
          </NavLink>
        ...
        <Switch>
          ...
          />
          <Route
            path={this.props.match.url + "/shoppings_items"}
            render={props => (
              <ShoppingItemsPage
                {...props}
                flightNumber={this.props.match.params.flightNumber}
